...
if __name__ == '__main__':
    ...
    parser.add_argument("--data_dir", default="/DATA/disk1/hyperplane/Deformable/Robocake_data")
    parser.add_argument("-output_path", default="/DATA/disk1/hyperplane/Deformable/sample_Robocake_data")

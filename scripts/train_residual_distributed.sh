...
CUDA_VISIBLE_DEVICES=0,1,2,3 python -m torch.distributed.launch --nproc_per_node=4 --master_port 30211 /home/tianyang/Robocake/train_residual_distributed.py \
  --stage dy \
	--data_type ngrip_fixed \
	--residual_n_epoch 5000 \
	--ckp_per_iter 1500 \
  ...
  --resume_prior_path /home/tianyang/Robocake/prior/dump_ngrip_fixed_desktop/3/prior_net_epoch_99_iter_1325/prior_model.pth \
  --exp_id 3 \
  --experiment_name residual_model_v100v3_exp3 \
  --batch_size 8 \
  --num_worker 8 \
...
CUDA_VISIBLE_DEVICES=4,5,6,7 python -m torch.distributed.launch --nproc_per_node=4 --master_port 30212 /home/tianyang/Robocake/train_residual_distributed.py \
  ...
  --resume_prior_path /home/tianyang/Robocake/prior/dump_ngrip_fixed_desktop/3/prior_net_epoch_99_iter_1325/prior_model.pth \
  --exp_id 4 \
  --experiment_name residual_model_v100v3_exp4 \
  --batch_size 8 \
  --num_worker 8 \
